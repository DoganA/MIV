...
<<<<<<< HEAD
listof=totoc,					% Abb.- und Tab.Verzeichnisse im Inhaltsverzeichnis aufführen
...
\usepackage{multirow}				%mehrere Zeilen einer bestimmten Spallte zusammenfügen
...
\begin{table}[htbp]
	\centering
		\begin{tabular}{|l|l|l|l|l|l|l|}
			\hline \multicolumn{2}{|c|}{Eigenschaften} 	 & Model A & Model A & Model B & Model B & \shortstack{Raspberry Pi 2\\ Model B}\\ \hline
			\multirow{3}{*}{\shortstack{Gesammtgröße\\(in mm)}}& Länge & 93 		 & 70,4  & \multicolumn{3}{|c|}{93}							 \\ \hline
																					 & Breite& 63,5 	 & 57,2  & \multicolumn{3}{|c|}{6,5}						 \\ \hline
																					 & Höhe  & 17 	 	 & 12		 & \multicolumn{3}{|c|}{20}							 \\ \hline
			\multicolumn{2}{|c|}{SoC}            				 & \multicolumn{4}{|c|}{Broadcom BCM2835}& \shortstack{Broadcom\\BCM2836}\\ \hline
			\multirow{4}{*}{CPU}							 & Typ   & \multicolumn{4}{|c|}{ARM1176JZF-S}		 & ARM Cortex-A7	 \\ \hline
																					 & Kern  & \multicolumn{4}{|c|}{1}				 & 4							 \\ \hline
																					 & Takt  & \multicolumn{4}{|c|}{700 MHz}					 & 900 MHz		 		 \\ \hline
																					 &Architektur& \multicolumn{4}{|c|}{ARMv6}       & ARMv7					 \\ \hline
\multicolumn{2}{|c|}{\shortstack{Anzahl der USB 2.0\\ Anschlüsse}}& \multicolumn{2}{|c|}{-}& 2  & \multicolumn{2}{|c|}{4}	 \\ \hline
			\multicolumn{2}{|c|}{Ethernet}							 & \multicolumn{2}{|c|}{-}& \multicolumn{3}{|c|}{10 und 100 MBit}\\ \hline
			\multicolumn{2}{|c|}{Pin}							 			 & 26 		 &	 40  & 26		& \multicolumn{2}{|c|}{40}\\ \hline
			\multicolumn{2}{|c|}{GPIO-Pins}							 & 17 		 &	 26  & 17		& \multicolumn{2}{|c|}{26}\\ \hline
			\multicolumn{2}{|c|}{Weitere Schnittstellen} & \multicolumn{5}{|c|}{1 × CSI, 1 × DSI, 1 × I$^2"$S} \\ \hline
			\multicolumn{2}{|c|}{Stromversorgung}				 & \multicolumn{5}{|c|}{15,0 V; über einen Micro-USB-Anschluss (Micro-USB-B)} \\ \hline
		\end{tabular}
	\caption{Raspberry Pi Modelle}
	\label{tab:RaspberryPiModelle}
\end{table}
...
\nocite{*} % adds all entries in the bib file to the bibliography
<<<<<<< HEAD
\printbibliography[nottype = online, title = {Quellenverzeichnis}]
\printbibliography[
	type 		= online,
